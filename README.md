Forked this library to replace Google libphonenumber (https://github.com/googlei18n/libphonenumber) with catamphetamine/libphonenumber-js (https://github.com/catamphetamine/libphonenumber-js). Later implementation is much simpler and should save 50% fat for dependencies.
